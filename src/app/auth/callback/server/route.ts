...
import { resolveAuthCallbackOrigin, toSafeNextPath } from "@/lib/auth-redirects";
...
export async function GET(request: Request) {
  ...
  const requestOrigin = resolveAuthCallbackOrigin({
    appUrl: process.env.NEXT_PUBLIC_APP_URL,
    forwardedHost: headerStore.get("x-forwarded-host"),
    forwardedProtocol: headerStore.get("x-forwarded-proto") ?? requestUrl.protocol.replace(":", ""),
