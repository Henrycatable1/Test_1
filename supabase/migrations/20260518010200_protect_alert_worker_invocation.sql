-- ### use the service role for scheduled alert jobs so public anon clients cannot trigger cross-cat workers
...
-- ### new log activity must release any previous claim so a crashed worker cannot hold the cat indefinitely
