-- ### require scheduled alert workers to call Edge Functions with the service-role bearer token
...
-- ### let new user activity recover a cat from any abandoned worker claim
