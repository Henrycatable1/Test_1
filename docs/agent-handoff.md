...
- Weight-change and kitten-stagnation alerts must stay active until a new weight is logged. A later food/activity/symptom record without a weight must not clear them.
- Known MVP gap:
